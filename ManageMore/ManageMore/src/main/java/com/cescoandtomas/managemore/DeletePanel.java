...
public class DeletePanel extends javax.swing.JPanel{
    ...
    public DeletePanel(JDialog jd, TableInfo info) {
    ...
    private boolean delete(String key){
        ...
        String query = "DELETE FROM " + info.dbName + " WHERE "+ info.pkey + " = "+ key;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(success){
            ...
            JOptionPane.showConfirmDialog(null,"Error: Cannot Find Entry", "Delete Error" ,JOptionPane.CANCEL_OPTION);
